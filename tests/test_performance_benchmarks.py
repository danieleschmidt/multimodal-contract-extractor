...
class TestPerformanceBenchmarks:
    ...
    def test_adaptive_loading_benchmark(self, tmp_path):
        ...
        print(f"\nSmall file processing time: {small_time:.3f}s")
        print(f"Large file processing time: {large_time:.3f}s")
    ...
    def test_ocr_caching_benchmark(self, tmp_path):
        ...
        print(f"Cache efficiency: {((cold_time - warm_time) / cold_time * 100):.1f}% improvement")
    ...
    def test_clause_detection_optimization_benchmark(self):
        ...
        with patch('multimodal_contract_extractor.clause_detection._ocr_image') as mock_ocr:
            ...
            print(f"\nLegacy detection time: {legacy_time:.4f}s")
            print(f"Optimized detection time: {optimized_time:.4f}s")
