...
class TestClauseDetectionOptimization:
    ...
    def test_optimized_detection_finds_same_clauses(self, tmp_path):
        ...
        with patch('multimodal_contract_extractor.clause_detection._ocr_image') as mock_ocr:
            ...
            original_types = set(clause.type for clause in original_clauses)
            optimized_types = set(clause.type for clause in optimized_clauses)
    ...
    def test_combined_regex_pattern_efficiency(self):
        ...
        from multimodal_contract_extractor.clause_detection import _build_combined_pattern, DEFAULT_KEYWORDS
    ...
    def test_pattern_caching_performance(self):
        ...
        from multimodal_contract_extractor.clause_detection import DEFAULT_KEYWORDS, _get_cached_pattern
    ...
    def test_empty_keywords_handling(self):
        ...
        from multimodal_contract_extractor.clause_detection import _build_combined_pattern
