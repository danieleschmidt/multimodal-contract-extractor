...
from src.multimodal_contract_extractor.neuromorphic_processing import (
    PhotonicNeuron, SynapticWeight, NeuromorphicLayer, ClausePattern,
    PhotonicNeuromorphicProcessor, NeuromorphicProcessingResult,
    NeuromorphicClause, NeuromorphicContractProcessor,
    get_neuromorphic_processor, process_document_with_neuromorphics,
